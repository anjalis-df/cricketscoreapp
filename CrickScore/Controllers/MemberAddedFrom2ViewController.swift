...
class MemberAddedFrom2ViewController: UIViewController {
    ...
    @objc func addTapped(){
        ...
        if isSecondTeamMember == true {
            ...
            for playerName in playerDetails {
                ...
                playerDetail.parent = MemberAddedFrom2ViewController.currentMatchUserDetail
    ...
    func loadTempData() {
        let predicate = NSPredicate(format: "parent.emailId MATCHES %@", (MemberAddedFrom2ViewController.currentMatchUserDetail?.emailId)!)
